...
# For PSoC 5 CyScope Dev Kits (10-26-2023)
...
def CyScope_Get_data():
    ...
    if TgInput.get() == 0:
        ...
        ser.write(SendByt)
    #
    iterCount = 4097 # 4 bytes per 1024 samples + D char at start
    MissTrig = 0
    ShiftA1 = 0
    ShiftB1 = 0
    ...
    while chr(Buffer[index]) != 'A':
        index = index + 1
##        if MissTrig > 0:
    # print("A: ", Buffer[0], Buffer[1], Buffer[2])
...
##            Count = Count + 512
    ...
    if chr(ABuff[0]) != 'D':
        index = 0
        # print("First Char was not D")
    else:
        index = 1
        # print("First Char was D")
